...
<head>
    ...
    <!-- Title -->
    <title>Aplikasi CRUD - IegCode</title>
    ...
    <footer class="footer mt-auto bg-white shadow py-4">
        <div class="container">
            ...
            <div class="copyright text-center mb-2 mb-md-0">
                &copy; 2024 - <a href="https://ibrahimelgibran.com/" target="_blank" class="text-brand text-decoration-none" style="color:#0d6efd">IegCode</a>. All rights reserved.
            </div>
        </div>
    </footer>
